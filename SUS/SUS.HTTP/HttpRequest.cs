...
namespace SUS.HTTP
{
    public class HttpRequest
    {
        ...
        public HttpRequest(string requestString)
        {
            ...
            SplitParamaneters(this.Body, this.FormData);
            SplitParamaneters(this.QueryString, this.QueryData);
        }

        private static void SplitParamaneters(string parametersAsString, IDictionary<string, string> output)
        {
            var parameters = parametersAsString.Split(new char[] { '&' }, StringSplitOptions
                            .RemoveEmptyEntries);
